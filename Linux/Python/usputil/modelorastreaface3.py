...
#             : 2016-11-07 Versao para processamento usando lucas-kanade
#             : 2016-11-09 Acrescentado limite para considear interessante o rastreamento
#                          e indicadores para analisar quantidade de amostras
#             : 2016-11-21 Atualizado para usar a mesma estrutura de ratreamento do OnCam2
#             : 2016-11-22
#             : 2016-12-04 Padronizando tratamento de argumentos
import os
import math
import argparse
...
parser.add_argument('--dir', type=str,
                    ...
                    #default="..\\..\\..\\teste") #D:\\temp
                    #default="D:\\temp\\HBPVR")
                    default="D:\\projetos\\Safety_City_offdata\\HBPVR")
...
parser.add_argument('--cascade', type=str,
                    ...
                    default=os.path.join('haarcascades','haarcascade_frontalface_alt2.xml')) #D:\\app\\opencv31\\sources\\data\\
...
def detect(img, cascade):
    ...
    rects = cascade.detectMultiScale(gray, scaleFactor=1.05, minNeighbors=2, # 3 2
                                     minSize=(120, 120))
    #if len(rects) == 0:
    #    return []
    #print rects
...
class TrackedFace():
    ...
    #fracmx o default era 4 teste com 2 <- problema quando face move muito rapido num
    #cenario com .. colocando em 3
    def updateVAI(self,grayimg,fracmx=3):
                ...
                if seq > 2:
                    ...
                    if seq == 3 and isCap:
                        ...
                        for idx,(cframe,sample) in enumerate(tf.listHistory):
                            mdb.gravaIm(sample, base, idx, cframe, datetime.now(), tf.identity, faceAlinhada)
                    else :
                        if isCap:
                            mdb.gravaIm(cropimg, base, seq, currentFrame, datetime.now(), tf.identity, faceAlinhada)

if __name__=="__main__":
    #tratador com valores default para url="mongodb://192.168.10.236:37027" e dbs="facecoleta"
    #mdb = libColetaFaceDB.MongoConn()
    ...
    # com 15 esta acontecendo continuacao de faces de possoas diferentes na mesma sequencia de rastreamento
    # mesmo com maxttl=7 apresenta problema - tratamento deve ser levando entre os frames adjacentes
    ...
    for arq in arquivos:
        ...
        while(temframe):
            ...
            if temframe:
                ...
                #Coletado as faces rastreadas
                trackingF.collectCurrentSamp(conta,frame,1.0,mdb=mdb,base="camara")
