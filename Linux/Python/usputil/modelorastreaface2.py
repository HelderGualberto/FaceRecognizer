...
#             : 2016-11-21 Atualizado para usar a mesma estrutura do OnCam2
import os
import math
import argparse
...
class TrackingFaces():
    ...
    #coletor de imagens
    def collectCurrentSamp(self,currentFrame,img,fator):
        for tf in self.listTrackedFaces:
            tf.collectSample(img,currentFrame,faceAli=True,fator=fator)
    ...
    for arq in arquivos:
        ...
        while(temframe):
            ...
            if temframe:
                ...
                trackingF.collectCurrentSamp(conta,frame,1.0)
